...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "Hack:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
const char *spcmd3[] = {TERMINAL, "-n", "spmusic", "-f", "Hack:size=10", "-g", "100x34", "-e", "ncmpcpp", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ TERMCLASS,      "spmusic",   NULL,       	    SPTAG(2),     1,           1,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_BackSpace,	spawn,		SHCMD("dmenu-keyboard") },
	...
	{ MODKEY,		XK_v,		spawn,		SHCMD("jellyfinmediaplayer") },
	{ MODKEY|ShiftMask,		XK_v,		spawn,		SHCMD("spotify") },
	/* C is automatically bound above in STACKKEYS */
	{ MODKEY,			XK_b,		togglebar,	{0} },
	/* { MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD("") }, */
	{ MODKEY|ShiftMask,			XK_n,		spawn,		SHCMD("dmenu-radio") },
	...
	{ MODKEY,			XK_F5,		spawn,		{.v = (const char*[]){ "dmenu-keyboard", NULL } } },
